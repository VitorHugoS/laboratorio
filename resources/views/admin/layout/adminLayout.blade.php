...
<div class="wrapper">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li class=""><a href="/admin/registrar"><i class="fa fa-circle-o"></i> Adicionar</a></li>
            <li><a href="/admin/clientes"><i class="fa fa-circle-o"></i> Listar</a></li>
          </ul>
        </li>
  ...
  <footer class="main-footer">
    <strong>Desenvolvido por ATA Design.
  </footer>
